...
class LightThemeColors {
  ...
  static const Color operatorButton = Color(0xFFFF6B6B);
...
class DarkThemeColors {
  ...
  static const Color operatorButton = Color(0xFF4ECDC4);
  static const Color functionButton = Color(0xFF383838);
